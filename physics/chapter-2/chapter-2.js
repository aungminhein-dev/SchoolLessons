        ...
        case 'fc_inclined':
            inputFields.innerHTML = `
                <div class="form-group">
                    <label for="velocity">Angular Displacement (theta):</label>
            ...
            case 'fc':
                inputFields.innerHTML = `
                    <div class="form-group">
                        <label for="velocity">Mass (m):</label>
                     ...
                     <div class="form-group">
                        <label for="velocity">Radius (r):</label>
...
document.getElementById('calculate').addEventListener('click', () => {
    ...
    switch (targeted_value) {
        case 'fc_inclined':
            angularDisplacement = parseFloat(document.getElementById('angular_displacement').value);
            
            message = `Centripetal Force (Fc) = ${(Math.cos(angularDisplacement)/ Math.sin(angularDisplacement)).toFixed(2)} N`;
            break;
            case 'fc':
                angularDisplacement = parseFloat(document.getElementById('angular_displacement').value);
                
                message = `Centripetal Force (Fc) = ${(mass*(velocity * velocity)/ radius)} N`;
                break;
        case 'ad':
